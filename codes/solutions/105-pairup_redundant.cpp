...
std::list<int> sum(std::list<int> const &first_list, std::list<int> const &second_list, function op)
{
    std::list<int> result{};
...
{
public:
    std::list<int> sum(std::list<int> const &first_list, std::list<int> const &second_list)
    {
        std::list<int> result{};
        if (first_list.size() != second_list.size())
            throw std::runtime_error("Can't pair up lists of unequal sizes");
...
pair_up(std::list<int> const &first_list, std::list<int> const &second_list)
{
